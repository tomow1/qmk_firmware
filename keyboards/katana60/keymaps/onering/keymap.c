...
#define K_CAPFN LT(CURS, KC_CAPS) // Tap for space, hold for symbols layer
...
[BASE] = LAYOUT( /* Base */
  ...
  K_CAPFN, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_PGUP,          KC_QUOT, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_PGDN,  KC_HOME,  KC_END, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
  MO(2),   KC_LCTL, KC_LGUI, KC_LALT,                   K_SPCFN, KC_ENT,  K_SPCFN,          KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,MO(2)
    ),
[NUMB] = LAYOUT(
  UC_M_WI, UC_M_LN, _______, _______, X(GBP),  X(EUR),  _______, DF(0),   KC_PSLS, KC_PAST, KC_PMNS, _______, _______, _______, _______,
...
[SYMB] = LAYOUT(
  RESET,   KC_NUBS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
...
[CURS] = LAYOUT(
  _______, _______, _______, _______, X(GBP),  X(EUR) , _______, _______, _______, _______, _______, _______, _______, _______, _______,
